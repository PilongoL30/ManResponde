...
<head>
    <meta charset="UTF-8">
    <title>ManResponde • Interactive Map</title>
        ...
        <main class="flex-1 overflow-y-auto aurora-background">
            <div class="pt-20 md:pt-6 pb-6 px-4 sm:px-6 md:px-8 lg:px-10 animate-fade-in relative z-10">
                <header class="mb-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-3xl md:text-4xl font-extrabold text-slate-900 tracking-tighter">Interactive Map</h1>
                            <p class="text-slate-500 mt-1 text-base md:text-lg">Real-time visualization of emergency incidents and responder locations.</p>
                        </div>
                    </div>
                </header>
