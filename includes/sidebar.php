<!-- Sidebar -->
        <aside class="hidden md:flex flex-col w-72 glass-card m-4 mr-0 relative z-20">
            ...
            <nav class="flex-1 overflow-y-auto py-6 px-4 space-y-2 custom-scrollbar">
                ...
                <a href="analytics.php" class="nav-item <?php echo $active; ?> flex items-center gap-3 px-4 py-3.5 rounded-xl text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-all group relative overflow-hidden">
                    <div class="absolute inset-0 bg-blue-50 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                ...
                <a href="interactive_map.php" class="nav-item <?php echo $active; ?> flex items-center gap-3 px-4 py-3.5 rounded-xl text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-all group relative overflow-hidden">
                    <div class="absolute inset-0 bg-blue-50 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                ...
                <a href="live_support.php" class="nav-item <?php echo $active; ?> flex items-center gap-3 px-4 py-3.5 rounded-xl text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-all group relative overflow-hidden">
                    <div class="absolute inset-0 bg-blue-50 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                ...
                <a href="create_account.php" class="nav-item <?php echo $active; ?> flex items-center gap-3 px-4 py-3.5 rounded-xl text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-all group relative overflow-hidden">
                    <div class="absolute inset-0 bg-blue-50 opacity-0 group-hover:opacity-100 transition-opacity"></div>
